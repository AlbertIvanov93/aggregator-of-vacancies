...
public class HHStrategy implements Strategy {
    ...
    private static final String URL_FORMAT = "https://spb.hh.ru/search/vacancy?text=java+junior+%s&salary=&area=2&ored_clusters=true&page=%d";
